...
class LoadingScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('btn_next_stat', 'assets/Menu/NEXT.gif'); 
       ...
       // Carrega o vídeo da gruta (ajusta o caminho da pasta se necessário)
        ...
        this.load.image('fundo_subida', 'assets/Fundo/Fundo_dentro/Gruta_fundo.png');
        this.load.image('plataformas_subida', 'assets/Fundo/Fundo_dentro/gruta_plataformas_02.png');
