class SceneTutorial extends Phaser.Scene {
    ...
    create() {
        ...
        // 🔥 CHÃO DESCIDO PARA 980 PARA ALINHAR COM A PONTE AZUL
        let chao = this.add.rectangle(w/2, 980, w * 3, 100, 0x000, 0); 
    ...
    iniciarFaseEstatua() {
        ...
        this.cameras.main.once('camerafadeoutcomplete', () => {
            ...
            this.estatua = this.physics.add.sprite(1200, 755, 'estatua_mana').setScale(0.45).setDepth(4.5);
